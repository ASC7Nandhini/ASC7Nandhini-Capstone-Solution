...
public class LoginServiceImpl implements LoginService{
    ...
    @Override
    public List<BookingModel> login(LoginDetailsModel loginDetailsModel){
        ...
        if(user.getPassword().equals(loginDetailsModel.getPassword())){
            ...
            user.setLockTime(null);
            loginDetailsRepository.save(user);
            List<BookingModel> bookingModelList=loginProxy.getAllBookings();
